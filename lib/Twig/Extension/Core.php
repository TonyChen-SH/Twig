 ...
 * @internal
 */
function twig_get_attribute(Twig_Environment $env, Twig_Source $source, $object, $item, array $arguments = [], $type = Twig_Template::ANY_CALL, $isDefinedTest = false, $ignoreStrictCheck = false)
{
    // array
    if (Twig_Template::METHOD_CALL !== $type)
    {
        ...
        if (Twig_Template::ARRAY_CALL === $type || !is_object($object))
        {
            ...
            } else if (Twig_Template::ARRAY_CALL === $type)
            {
                if (null === $object)
                {
